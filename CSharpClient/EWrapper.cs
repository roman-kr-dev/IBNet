...
namespace IBApi
{
    ...
    public interface EWrapper
    {
        ...
        void historicalData2(int reqId, string date, double open, double high, double low, double close, int volume, int count, double WAP, bool hasGaps, int recordNumber, int recordTotal);
